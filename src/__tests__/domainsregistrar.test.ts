...
test("Domains Registrar Get Tld Price", async () => {
  ...
  expect(result).toEqual({
    years: 8935.16,
    purchasePrice: 7886.17,
    renewalPrice: 4537.84,
    transferPrice: 7204.57,
  });
});
...
test("Domains Registrar Get Domain Price", async () => {
  ...
  expect(result).toEqual({
    years: 40.44,
    purchasePrice: 1523.71,
    renewalPrice: 3417.52,
    transferPrice: 7908.61,
  });
});
    ...
    domains: [
      {
        ...
        years: 340.32,
        domainName: "average-farmer.name",
        status: "failed",
        price: 3271.32,
      },
    ],
